...
Currently (`v0.16.1`) it automates the provisioning of hardened **Hetzner VPS**
...
As of now (`v0.16.1`) you'll need 2 accounts: one for Hetzner and one for Cloudflare.
