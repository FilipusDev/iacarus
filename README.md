...
Currently (`v0.18.3`) it automates the provisioning of hardened **Hetzner VPS**
...
As of now (`v0.18.3`) you'll need 2 accounts: one for Hetzner and one for Cloudflare.
