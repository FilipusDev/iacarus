...
Currently (`v0.10.0`) it automates the provisioning of hardened **Hetzner VPS**
...
As of now (`v0.10.0`) you'll need 2 accounts: one for Hetzner and one for Cloudflare.
