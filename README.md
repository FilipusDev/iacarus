...
Currently (`v0.13.2`) it automates the provisioning of hardened **Hetzner VPS**
...
As of now (`v0.13.2`) you'll need 2 accounts: one for Hetzner and one for Cloudflare.
